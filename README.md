...
```
cd existing_repo
git remote add origin https://gitlab-student.centralesupelec.fr/2019ageronr/ml-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-student.centralesupelec.fr/2019ageronr/ml-project/-/settings/integrations)
